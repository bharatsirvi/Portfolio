...
import { X, ChevronDown, Star, ExternalLink, Github } from 'lucide-react';
...
const ProjectModal = ({ project, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gradient-to-br from-slate-900 to-purple-900 rounded-2xl border border-purple-500/20 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
...
const ModalContent = ({
  ...
  return (
    <>
      ...
      <div className="mb-6">
        <h3 className="text-xl font-bold text-white mb-4">More Screenshots</h3>
  ...
  <div className="mb-6">
    ...
    <div className="flex flex-wrap gap-2">
      {technologies.map((tech, index) => (
        <span
          key={index}
          className="px-3 py-1 bg-purple-600/20 text-purple-400 rounded-full"
        >
          {tech}
        </span>
      ))}
...
const ShowMoreButton = ({ onClick, isShowingAll, count, variant }) => (
  ...
  >
    <span>
      {isShowingAll ? "Show Less" : `Show More (${count} more)`}
    </span>
    <ChevronDown
